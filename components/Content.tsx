  ...
  return (
    <div className="flex justify-between items-center p-10 bg-gradient-to-r from-gray-900 via-slate-700 to-slate-400 max-w-full">
      <div className="w-1/2 pl-12 relative">
        <Image src="/contentPic.jpg" width={600} height={600} alt="Content Pic" className="rounded-xl"/>
        <div className="fixed z-50 left-[12vw] top-[33vh] flex justify-between items-center gap-44 bg-gradient-to-r from-gray-900 to-slate-700 p-5">
